...
const ProjectsCard = ({ title, des, src, store, storeLink, appStore }) => {
    return (
                ...
                <div>
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-2">
                            <span
                                onClick={() => {
                                    toast.success("Contact us for source codes")
                                }}
                            ...
                            <span onClick={() => { window.open(storeLink, '_blank'); }} className="text-lg w-10 h-10 rounded-full bg-black inline-flex justify-center items-center text-gray-400 hover:text-designColor duration-300 cursor-pointer">
                                {
